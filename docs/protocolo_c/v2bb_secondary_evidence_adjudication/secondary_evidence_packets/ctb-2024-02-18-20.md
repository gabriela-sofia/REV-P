# Secondary Evidence Adjudication Packet: CTB_2024_02_18_20

## 1. Identificacao do pacote
`ARP_v2az_0008` / `FACT_v2at_0008`.

## 2. Resumo temporal da v2ay
INMET A807; total=97.400 mm; max1h=32.000 mm; max24h=47.400 mm; missing=0.000
