# Secondary Evidence Adjudication Packet: PET_2024_03_21_28

## 1. Identificacao do pacote
`ARP_v2az_0009` / `FACT_v2at_0009`.

## 2. Resumo temporal da v2ay
INMET A610; total=336.000 mm; max1h=34.600 mm; max24h=136.600 mm; missing=0.000
