...
- [`datasets/official_open_event_vector_discovery_registry.csv`](../../datasets/official_open_event_vector_discovery_registry.csv) — descoberta e validação de vetores em bases abertas (v1ih): 18 candidatos × 10 gates — 0 ground truth
- [`datasets/schemas/official_open_event_vector_discovery_registry_schema.csv`](../../datasets/schemas/official_open_event_vector_discovery_registry_schema.csv) — schema 30 campos v1ih
- [`datasets/targeted_official_repository_event_vector_registry.csv`](../../datasets/targeted_official_repository_event_vector_registry.csv) — mineração em repositórios oficiais (v1ii-R1): 12 recursos × 6 repositórios — 0 ground truth, lacuna confirmada
- [`datasets/schemas/targeted_official_repository_event_vector_registry_schema.csv`](../../datasets/schemas/targeted_official_repository_event_vector_registry_schema.csv) — schema 27 campos v1ii-R1
- [`docs/metodologia_cientifica/protocolo_c_descoberta_validacao_vetores_eventos_observados_v1ih.md`](protocolo_c_descoberta_validacao_vetores_eventos_observados_v1ih.md) — metodologia v1ih: 10 gates, candidatos locais, lacuna de disponibilidade pública documentada
- [`docs/metodologia_cientifica/protocolo_c_relatorio_descoberta_validacao_vetores_eventos_observados_v1ih.md`](protocolo_c_relatorio_descoberta_validacao_vetores_eventos_observados_v1ih.md) — relatório v1ih: 18 candidatos auditados, Gate 05 mais restritivo (39%), PET_LOCAL_005 melhor candidato
- [`docs/metodologia_cientifica/protocolo_c_mineracao_dirigida_repositorios_oficiais_v1ii.md`](protocolo_c_mineracao_dirigida_repositorios_oficiais_v1ii.md) — metodologia v1ii-R1: 6 scanners reais, critérios de falha controlada, invariantes, classificações de recurso
- [`docs/metodologia_cientifica/protocolo_c_relatorio_mineracao_dirigida_repositorios_oficiais_v1ii.md`](protocolo_c_relatorio_mineracao_dirigida_repositorios_oficiais_v1ii.md) — relatório v1ii-R1: 6 repositórios, 12 recursos, 0 ground truth, lacuna de disponibilidade pública confirmada
