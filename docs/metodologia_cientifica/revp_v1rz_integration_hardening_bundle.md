...
Consolidar v1rs-v1ry: inventário, grafo de dependências, guardrail audit, commit readiness, runbooks e próximas ações reais.

## Estado de integração

final_status=INTEGRATION_HARDENING_WAITING_LOCAL_MODEL_AND_DATA. Artefatos: 464. Guardrail violations: 0. Recomendados para staging: 1326.
