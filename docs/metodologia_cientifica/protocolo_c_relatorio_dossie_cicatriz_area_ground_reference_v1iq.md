# Relatório Científico: Dossiê de camada de feições poligonais de deslizamento fotointerpretadas — Ground Reference (v1iq)
...
v1iq-R2 executou investigação focada em camada original de feições poligonais de deslizamento fotointerpretadas com leitura real de arquivos locais:
...
feições de deslizamento são ocorrências observadas por fotointerpretação:
- TIPO=Deslizamento/feição de deslizamento (campo DBF)
...
**Conclusão:** As feições de deslizamento são cumulativas e históricas. O DBF foi criado em 2015, anterior ao evento de 2022-02-15. Sem campo de data nas feições, sem notas em OBS, sem qualquer expressão temporal nos atributos. O bloqueio temporal é estrutural e confirmado em três camadas independentes (cabeçalho DBF, valores DBF, registry v1ij).

### Gate 6: Document-Vector Linkage
**Status:** ✗ WEAK

**Evidência do XML sidecar (sidecar original de pontos de feições de deslizamento fotointerpretadas):**
- CreaDate: **20150122**
...
- **0 linkadas** a candidatos específicos (camada de feições poligonais de deslizamento fotointerpretadas)

**Conclusão:** Nenhum documento auditado declara explicitamente que camada original de feições poligonais de deslizamento fotointerpretadas representa feições mapeadas especificamente após 2022-02-15. O vínculo é fraco (WEAK).
...
- Documento SGB: feições de deslizamento de deslizamento em Petrópolis
...
**Por que `has_source_in_field = NO`:** O campo FONTE contém `Fotointerpretação` — que é o método de produção das feições de deslizamento, não a instituição. SGB, CPRM, RIGeo não aparecem em nenhum campo do DBF. A autoridade institucional vem do registro externo (v1ij/RIGeo), não dos atributos do shapefile.
...
| **Fenômeno** | ✓ SIM | Movimento de massa / feições de deslizamento — TIPO no DBF |
| **Fonte Oficial** | ✓ SIM | SGB/CPRM (HIGH authority) — RIGeo URL confirmado |
| **Region Match** | ✓ SIM | Petrópolis (ambos) — DBF + registry |
| **Phenomenon Match** | ✓ SIM | MM/feições de deslizamento (ambos) — DBF + registry |
| **Evento Documentado (2022)** | ✗ NÃO-LINKADO | Data existe em documentos, mas SIG é de 2013-2015 |
| **Data no Vetor** | ✗ NÃO | DBF date=2015; sem campo DATA; feições de deslizamento cumulativas |
...
- feições de deslizamento são cumulativas e históricas
...
```
camada original de feições poligonais de deslizamento fotointerpretadas + documento oficial SGB + "data 2022-02-15"
...
```
✓ camada original de feições poligonais de deslizamento fotointerpretadas (completo)
...
Confirmação explícita de que camada original de feições poligonais de deslizamento fotointerpretadas inclui feições mapeadas especificamente após 2022-02-15 em documento oficial SGB/CPRM, ou campo de data no shapefile discriminando feições por evento.
...
2. **feições de deslizamento são cumulativas** — 444 feições sem campo de data, criadas em contexto de mapeamento de susceptibilidade, não de resposta ao evento de 2022.
...
- Mensagem de commit: "camada de feições poligonais de deslizamento fotointerpretadas confirmada como STRONG_COMPOSITE_BUT_TEMPORAL_LINK_WEAK via leitura real de metadados"
