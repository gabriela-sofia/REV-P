...
- snapshots oficiais: `1`
- data/janela confirmada: `2022-01-15`
- fenomeno: `urban_flooding|intense_rain`
- text extraction rows: `1`
- hydromet support rows: `1`
- GeoCuritiba/context layers: `3`
- open data resources: `4`
- event-patch prelink rows: `54`
- blockers: `10`
- status final: `CURITIBA_EVENT_CANDIDATE_HYDROMET_SUPPORTED`
- proxima etapa: `v1ux - Curitiba Public Evidence Download and Schema Audit`
