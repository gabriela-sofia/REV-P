...
| v1gg | `scripts/dino/revp_v1gg_dino_review_gate_package.py` | Pacote de revisão supervisora apenas local para medoids, outliers, pontes e representantes | índice de evidência estrutural do v1gf e manifests visuais locais | `local_runs/dino_embeddings/v1gg/` | manifest de revisão, lotes, README local, guardrails de revisão supervisora | implementado |
