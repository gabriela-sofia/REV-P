...
- download targets: `9`
- downloads/inventoried artifacts: `6`
- artifact types: `CSV|GeoJSON|HTML|PDF|ZIP`
- schema audit rows: `6`
- geodata audit rows: `2`
- event table detections: `6`
- evidence classifications: `6`
- readiness update rows: `6`
- next action: `v1uy - Curitiba Public Geodata Deepening`
