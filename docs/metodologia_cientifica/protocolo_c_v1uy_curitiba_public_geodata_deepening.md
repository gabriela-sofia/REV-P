...
- content mismatches resolved: `2`
- endpoints probed: `12`
- layer metadata rows: `12`
- feature schema samples: `12`
- layer classes: `ADMINISTRATIVE_CONTEXT_LAYER=2|DRAINAGE_CONTEXT_LAYER=2|UNKNOWN_CONTEXT_LAYER=8`
- possible occurrence audit rows: `0`
- controlled download plan status: `NO_CONTROLLED_DOWNLOAD_RECOMMENDED`
- readiness update rows: `6`
- blocker rows: `9`
- next action: `v1uz - Hold Curitiba Context Only`
