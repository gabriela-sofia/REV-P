# v1sz — Hydrometeorological Context Bundle
...
## Resultado
final_status=HYDROMET_CONTEXT_READY_REVIEW_ONLY. Estacoes: 25. Janelas: 9. Contexto: 810 rows. Guardrail: GUARDRAIL_PASS_ALL.
