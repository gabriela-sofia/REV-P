...
%% Versão: v7 (2026-08-16) — estado atual do pipeline após a resolução única
%% de 30 m (reversão declarada de "a resolução segue o mecanismo") e a
%% correção da fonte de chuva única em Recife: números de E2, Fig. 2(b) e os
%% parágrafos de material externo e de limitações atualizados; nenhuma
%% mudança de conteúdo além do que esses dois eventos tornaram desatualizado.
%% =====================================================================
...
próprio é o que menos transfere. A derivação precisa ser única entre regiões, na mesma
resolução para toda a base --- inclusive onde isso custa detalhe que o
próprio modelo não usa. E a relação terreno--inundação não caduca: em 25
...
com 64.989 pontos elegíveis ao ajuste fluvial, nenhum deles mais em cadeia de
...
Falta a validação prospectiva e a camada de explicação.
...
os três desafios que orientam o plano. Nenhuma fonte cobre todas as
variáveis --- a chuva só existe no piloto inglês e nas duas regiões
brasileiras, nenhuma delas no conjunto que hoje entra no ajuste fluvial ---,
por isso o modelo multirregião roda com quatro variáveis de terreno. A
definição de negativo muda o que o modelo aprende: o
...
geoespacial única, 64.989 pontos elegíveis ao ajuste fluvial, com as quatro
...
publicada; 21 de 22 testes de invariante passam nesta execução, com a
checagem de reprodutibilidade bit-exata ainda sensível à versão de biblioteca
entre ambientes.
