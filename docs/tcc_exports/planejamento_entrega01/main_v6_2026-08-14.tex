...
%% Versão: v6 (2026-08-14) — problema de terreno generalizado (não só cota
%% rebaixada), referência brasileira somada à global, AOI justificada como
%% unidade de retorno do produto, DINOv2 nomeado e ligado à explicação na Fig. 1.
%% =====================================================================
...
O plano se apoia no artigo anterior: revisão de literatura e testes
sucessivos já fixaram as decisões que mudaram a rota. Variável derivada
...
rotulado para comparar; o modelo de Recife, com 278 pontos; o conjunto de
Curitiba, com 1.471 unidades; a tabela única harmonizada das seis fontes; e o
motor de inferência exposto por contrato. Externas: Copernicus EMS e Environment
Agency do Reino Unido contribuem ponto ao ajuste fluvial; Sen1Floods11 e UFO
estão no esquema, sem contribuição ainda por cadeia de terreno global. Falta a
validação prospectiva e a camada de explicação.
...
sobre esse \emph{payload} já decidido que a camada de explicação atua --- o
padrão de predição seletiva~\cite{mitchell2019}. O contrato roda hoje como MVP
local para Recife.
...
geoespacial única, 33.071 pontos elegíveis ao ajuste fluvial. \emph{Evidência}:
contagem do que entra e do que sai por fonte publicada; 18 de 19 testes de
invariante passam, com a checagem de reprodutibilidade bit-exata ainda
instável entre ambientes.
