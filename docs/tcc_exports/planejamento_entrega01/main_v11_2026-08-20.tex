...
Petrópolis responde \texttt{region\_not\_supported}, porque ter modelo de serra
ajustado não é o mesmo que ter região mapeada. Estender às demais é o objetivo
declarado de E5, não uma limitação de infraestrutura.
...
Petrópolis, \texttt{region\_not\_supported}, sem escore por analogia.
