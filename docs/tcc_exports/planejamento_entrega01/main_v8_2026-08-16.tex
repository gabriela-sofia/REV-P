...
%% Versão: v8 (2026-08-16) — nota a nota sobre o rascunho v1 do plano de
%% produto (MVP/regiões, infraestrutura, duplicação de rótulo positivo,
%% definição operacional de suscetibilidade, base consolidada, objetivo) e
%% realinhamento contra os commits do dia (recuperação de chuva para 100% da
%% base, 114 pontos de Curitiba em exclusão qualificada). Ver NOTA_versoes.md
%% §11 para o detalhe nota a nota.
%% =====================================================================
...
local para Recife --- única região com modelo auditado e validação
prospectiva executada; Curitiba tem modelo próprio, mas colapso prospectivo de
2026 sem causa isolada, e Petrópolis segue com zero pontos rotulados (filtro
COBRADE aplicado, resultado nulo). Estender às demais é o objetivo declarado
de E5, não uma limitação de infraestrutura.
...
são causais}. Chuva recuperada para 100\% da base harmonizada; quantas variáveis
entram em cada ajuste é decisão de E3. A rota primária segue linear mesmo quando o
