...
```bash
python outputs_public/data/linha_causal/susc_20i_janelas_evento_2023_2026/scripts/fetch_s2id_municipio.py --uf PR --ibge 4106902 --de 2023 --ate 2026 --outdir local_runs/susc_20i/s2id
```
