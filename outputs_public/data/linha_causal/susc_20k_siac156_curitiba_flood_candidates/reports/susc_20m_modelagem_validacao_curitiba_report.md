...
```
python outputs_public/data/linha_causal/susc_20k_siac156_curitiba_flood_candidates/scripts/pipeline_v20m_curitiba_primary.py
...
Resultados em `outputs_public/data/linha_causal/susc_20k_siac156_curitiba_flood_candidates/results/`.
