...
```
python outputs_public/data/linha_causal/susc_20k_siac156_curitiba_flood_candidates/scripts/pipeline_v20m_curitiba_primary.py --dataset ../registries/v20n_dataset_curitiba_features_v2.csv --primario 5feat --tag v20n
```
