...
```
python outputs_public/data/linha_causal/susc_20k_siac156_curitiba_flood_candidates/scripts/pipeline_v20v_gbm_decomposition_and_model_sweep_curitiba.py
```
