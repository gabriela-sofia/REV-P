# Cartao fisico/topografico S17C6_CANARY_REC_00004
...
- rain_idx=0.2567; urban_spectral_idx=0.4163; vegetation_idx=0.5219; moisture_idx=0.5734
...
- Patch oficial de referencia: `recife_00552` a 3112.4000 m; sobreposicao=0.0000
- Tipo: referencia_comparativa_review_only
- Direta ou comparativa: comparativa

## Incerteza

- Penalidade de incerteza aplicada ao componente fisico: 0.4813 (referencia distante, sem sobreposicao)

## Impacto na prontidao de calibracao

- Score exploratorio sem fisico: 0.3550 (classe low)
- Score exploratorio com fisico comparativo penalizado: 0.4356 (classe medium)
