# Cartao fisico/topografico S17C6_CANARY_REC_00003
...
- rain_idx=0.2567; urban_spectral_idx=0.4602; vegetation_idx=0.5880; moisture_idx=0.4637
...
- Patch oficial de referencia: `recife_00552` a 2791.7000 m; sobreposicao=0.0000
- Tipo: referencia_comparativa_review_only
- Direta ou comparativa: comparativa

## Incerteza

- Penalidade de incerteza aplicada ao componente fisico: 0.5347 (referencia distante, sem sobreposicao)

## Impacto na prontidao de calibracao

- Score exploratorio sem fisico: 0.3589 (classe low)
- Score exploratorio com fisico comparativo penalizado: 0.4449 (classe medium)
