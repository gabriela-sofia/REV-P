...
Uso:
    python detect_water_candidates.py --before-dir <dir_pre> --after-dir <dir_pos>
...
# Limiares default. Todos parametrizáveis; nenhum é feature de modelo.
...
def detect_water_candidates(
    ...
    result = DetectionResult(
        consensus_basis="NDWI_MNDWI_AWEI" if has_b12 else "NDWI_MNDWI_ONLY_WEAKER",
...
def main(argv=None) -> int:
    ...
    res = detect_water_candidates(before, after, cfg, transform=transform, crs=crs)
    ...
    summary = {
        ...
        "consensus_basis": res.consensus_basis,
