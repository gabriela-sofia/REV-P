...
def read_at_point(raster_dir: Path | str, lat: float, lon: float, label: str = "") -> dict:
    raster_dir = Path(raster_dir)
    out: dict = {"label": label, "lat": lat, "lon": lon, "raster_dir": str(raster_dir)}
...
def main(argv=None) -> int:
    ...
    res = read_at_point(args.raster_dir, args.lat, args.lon, args.label)
