...
REGIONS: dict[str, RegionInfo] = {
    ...
    "curitiba": RegionInfo(
        ...
        status_note=(
            ...
            "suscetibilidade a enchente -- executado e verificado nesta sessão): testada a "
            ...
            "explícito de esgotar toda vertente de literatura -- executado e verificado nesta "
            "sessão): (1) bootstrap CI do AUC holdout = [0,4535; 0,5959] -- inclui 0,5 (acaso), "
            ...
            "testadas, ambas NEGATIVAS -- executado e verificado nesta sessão): SUSC-20R "
            ...
            "ATUALIZAÇÃO 2026-08-02 (SUSC-20T+20U, mais 4 vertentes testadas -- executado e "
            "verificado nesta sessão): SUSC-20T -- (1) lançamento real do CuritibaApp "
            ...
            "executado e verificado nesta sessão): modelo aditivo por construção (spline "
            ...
            "encerra a vertente GAM -- executado e verificado nesta sessão): termo de "
