# Cartao de prontidao S17D_VAL_0001

## Identificacao do item

- Item de validacao: `S17D_VAL_0001`
- Evento candidato: `S17C_REF_0063`
- Patch canario: `S17C6_CANARY_REC_00002`
...
- NDVI=-0.0203 (espectral)
- NDWI=0.0397 (espectral)
- MNDWI=0.2812 (espectral)
- NDBI=-0.2441 (espectral)
...
- Score exploratorio review-only (baseline): 0.3469 (classe low)
