# Cartao de prontidao S17D_VAL_0004

## Identificacao do item

- Item de validacao: `S17D_VAL_0004`
- Evento candidato: `S17C_REF_0063`
- Patch canario: `S17C6_CANARY_REC_00004`
...
- NDVI=0.0438 (espectral)
- NDWI=-0.0213 (espectral)
- MNDWI=0.1467 (espectral)
- NDBI=-0.1675 (espectral)
...
- Score exploratorio review-only (baseline): 0.3550 (classe low)
