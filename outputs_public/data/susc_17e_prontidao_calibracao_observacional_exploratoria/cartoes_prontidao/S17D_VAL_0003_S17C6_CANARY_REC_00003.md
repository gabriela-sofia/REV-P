# Cartao de prontidao S17D_VAL_0003

## Identificacao do item

- Item de validacao: `S17D_VAL_0003`
- Evento candidato: `S17C_REF_0063`
- Patch canario: `S17C6_CANARY_REC_00003`
...
- NDVI=0.1761 (espectral)
- NDWI=-0.1513 (espectral)
- MNDWI=-0.0725 (espectral)
- NDBI=-0.0796 (espectral)
...
- Score exploratorio review-only (baseline): 0.3589 (classe low)
