# REV-P v2ey ground truth recovery final dashboard

Rows generated: 1

Final dashboard separates complete recovery, partial recovery, fallback-only continuity, and blocked recovery.
