# CASE_010 — REGION_LEVEL_petropolis (petropolis)
...
- **Região:** petropolis
- **Patch:** REGION_LEVEL_petropolis
- **Relação espacial:** same_region_period
- **evidence_id:** EVID_OBS_0000
- **coordinate_id:** 
- **Fonte:** SUSC-07A regional/documentary  ()
- **Geometria:** 
- **Data/período:** dated
- **Score/proxy:** 
- **Features físicas:** 
