...
OUT_PREV = ROOT / "outputs_public" / "data" / "susc_17c_strong_reference_acquisition_canary"
OUT_DATA = ROOT / "outputs_public" / "data" / "susc_17c5_geometry_to_patch_linkage_resolver"
