...
Nenhuma etapa extrai feature, promove rotulo ou treina. So adquire.

Uso:
    python scripts/externo/aq_master.py --sondar
    python scripts/externo/aq_master.py --baixar
    python scripts/externo/aq_master.py --baixar --so dem,hand,worldcover
"""
...
CATALOGO = {
    ...
    "hand": (alvo_hand, "Global 30m HAND -- feature hand_m", "Copernicus/ASF, livre"),
...
def modo_baixar(somente: set[str] | None) -> int:
    ...
    (OUT / "PROVENIENCIA.md").write_text(
        ...
        "  evento ocorrido.\n"
        "- Status: AQUISICAO. Nenhuma feature extraida, nenhum rotulo\n"
