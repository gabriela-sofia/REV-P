...
projeto. Eles entraram no `ds01` com TODAS as colunas de feature vazias, por
...
Uso:
    python scripts/externo/n1g_features_nos_pontos.py
    python scripts/externo/n1g_features_nos_pontos.py --limite-tiles 20
"""
