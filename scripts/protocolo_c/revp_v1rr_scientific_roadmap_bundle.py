...
def run(datasets: Path | None = None) -> dict[str, Any]:
    ...
    steps = [
        {"step_id": "V1RR_ST01", "priority": "P0", "module_scope": "external_intake",
         ...
         "model_recommendation": "revisao supervisora", "done_when": "intake validado pass", "notes": ""},
        {"step_id": "V1RR_ST02", "priority": "P0", "module_scope": "double_review",
         ...
         "risk": "desacordo entre revisores", "model_recommendation": "dupla revisao supervisora",
