...
def build_decisions_table() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"level": "C2",
         ...
         "current_count": c2,
         "allowed_use": "Representacao DINO review-only; revisao supervisora futura; planejamento de aquisicao",
        ...
        {"level": "C3",
         ...
         "prohibited_use": "Ground truth operacional; label sem revisao supervisora; treinamento direto",
        ...
        {"level": "C3+",
         ...
         "current_count": "0",
         "allowed_use": "Review-only avancado; candidato a revisao supervisora formal",
